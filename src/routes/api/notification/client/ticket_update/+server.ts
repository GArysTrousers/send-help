...
export const POST: RequestHandler = async ({ request, locals }) => {
  ...
  let ticket = sql.getOne<DbTicket & DbUser>(`
    ...
    WHERE ticketId = :ticketId`, { ticketId: body.ticketId })
  ...
  await sendEmail({
    ...
    html: `Your ticket has been updated. <a href="http://localhost:5173/my?=${ticket.ticketId}">Click here to go to your ticket</a>`
  })
  return json({})
}